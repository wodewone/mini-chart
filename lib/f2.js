    ...
    return function (t) {
        ...
        r.Array = {
            merge: function (t) {
                ...
                var i = r.Array.groupToMap(t, e), a = [];
                if (1 === e.length && n[e[0]]) {
                    var o = n[e[0]];
                    r.each(o, function (t) {
                        t = "_" + t, a.push(i[t])
        ...
        var i = n(47), r = n(0), a = {
            ...
            trackable: !0,
            scales: {},
            widthRatio: {column: .5, rose: .999999, multiplePie: .75},
            lineDash: [4, 4]
        };
        ...
        var a = n(0), o = n(32), s = ["color", "size", "shape"], c = n(1), u = n(63), l = n(6), h = n(20),
            f = function (t) {
                function e() {
                    return t.apply(this, arguments) || this
                }
                ...
                return n.getDefaultCfg = function () {
                    ...
                    var t = this, e = t.get("attrs"), n = t.get("attrOptions"), i = t.get("coord");
                    for (var o in n) if (n.hasOwnProperty(o)) {
                        var s = n[o], c = a.upperFirst(o), l = r(s.field);
                    ...
                    if (n) {
                        ...
                        var r = e.getXScale(), o = e.getYScale(), s = a.mix({xField: r.field, yField: o.field}, n);
                    ...
                    for (var i = a.Array.merge(n), r = e.min, o = e.max, s = 0, c = i.length; s < c; s++) {
                        var u = i[s], l = Math.min.apply(null, u[t]), h = Math.max.apply(null, u[t]);
                        l < r && (r = l), h > o && (o = h)
                    }
                    ...
                    for (var e = this, n = e.get("attrs"), i = e.getYScale().field, r = [], o = 0, s = t.length; o < s; o++) {
                        ...
                        for (var l in n) if (n.hasOwnProperty(l)) {
                            var h = n[l], f = h.names, p = e._getAttrValues(h, c);
                    ...
                    for (var e = this, n = e.getShapeFactory(), i = e.getAttr("shape"), r = 0, a = t.length; r < a; r++) {
                        var o = t[r], s = e.createShapePointsCfg(o), c = i ? e._getAttrValues(i, o) : null,
                    ...
                    var n = [];
                    if (a.isArray(t)) for (var i = 0, r = t.length; i < r; i++) {
                        var o = t[i];
                        n.push(e.scale(o))
                    } else n = e.scale(t);
                    return n
                    ...
                    var e = this, n = e.get("coord"), i = e.getXScale(), r = e.getYScale(), o = i.field,
                        s = e.get("dataArray");
                    ...
                    var n = this.get("type"), i = c.shapes[n] || [];
        ...
        var i = n(0), r = n(1), a = {}, o = {
            ...
            defaultShapeType: null, setCoord: function (t) {
                this._coord = t
            }, getShape: function (t) {
                var e = this;
                i.isArray(t) && (t = t[0]);
        ...
        a.registerFactory = function (t, e) {
            ...
            var r = i.upperFirst(t), s = a[r], c = i.mix({}, o, n);
            return s[e] = c, c
        ...
        var i = {Canvas: n(85), Group: n(36), Shape: n(2), Matrix: n(22), Vector2: n(3)};
        ...
        function a(t) {
            for (var e = 1 / 0, n = -1 / 0, r = 1 / 0, a = -1 / 0, o = {x: t[0], y: t[1]}, s = {
                x: t[2],
                y: t[3]
            }, c = {x: t[4], y: t[5]}, u = {x: t[6], y: t[7]}, l = 0; l < 100; l++) {
        ...
        var o = n(3), s = o.create(), c = o.create(), u = o.create();
        t.exports = {
            getBBoxFromPoints: function (t) {
                ...
                var l = Math.abs(i - r);
                if (l % Math.PI * 2 < 1e-4 && l > 1e-4) return {minX: t - n, minY: e - n, maxX: t + n, maxY: e + n};
        ...
        var i = n(0), r = {min: 0, median: .5, max: 1}, a = function () {
            function t(t) {
            ...
            return e._initDefaultCfg = function () {
                ...
                var n = parseFloat(e[0]) / 100, i = parseFloat(e[1]) / 100, r = t.start, a = t.end,
                    o = Math.abs(r.x - a.x), s = Math.abs(r.y - a.y);
                ...
                var o = n._getNormalizedValue(e[0], r), s = n._getNormalizedValue(e[1], a[0]),
        ...
        var r = n(76), a = n(11), o = n(23), s = n(21), c = function () {
            function t(e) {
            ...
            return t.prototype._initDefaultCfg = function () {
                ...
                return a(e, function (e) {
                    var i = void 0;
                    i = o(e) ? e : {text: t.getText(e), tickValue: e, value: t.scale(e)}, n.push(i)
                }), n
        ...
        var i = n(23), r = n(77);
        t.exports = function (t, e) {
            if (t) if (r(t)) for (var n = 0, a = t.length; n < a && !1 !== e(t[n], n); n++) ; else if (i(t)) for (var o in t) if (t.hasOwnProperty(o) && !1 === e(t[o], o)) break
        }
    }, function (t, e, n) {
        function i(t, e) {
            if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
        ...
        var a = n(67), o = n(19), s = n(68), c = n(34), u = function () {
            function t(e) {
        ...
        var c = n(32), u = n(60), l = n(0), h = n(61), f = n(4), p = n(74), g = n(82), d = n(1), v = n(7).Canvas,
            y = n(26), m = function (t) {
                function e(e) {
                ...
                i(e, t), e.initPlugins = function () {
                    return {
                        _plugins: [], _cacheId: 0, register: function (t) {
                            ...
                            var i, r, a, o, s, c = this.descriptors(t), u = c.length;
                            for (i = 0; i < u; ++i) if (r = c[i], a = r.plugin, "function" == typeof (s = a[e]) && (o = [t].concat(n || []), !1 === s.apply(a, o))) return !1;
                            return !0
                ...
                return n.getDefaultCfg = function () {
                    ...
                    var t = this.get("plotRange"), e = l.mix({type: "cartesian"}, this.get("coordCfg"), {plot: t}),
                        n = e.type, i = new (0, h[l.upperFirst(n)])(e);
                    this.set("coord", i)
                }, n._initLayout = function () {
                    var t = this.get("_padding");
                    t || (t = this.get("margin") || this.get("padding"), t = l.parsePadding(t));
                    var e = "auto" === t[0] ? 0 : t[0], n = "auto" === t[1] ? 0 : t[1], i = "auto" === t[2] ? 0 : t[2],
                        r = "auto" === t[3] ? 0 : t[3], a = this.get("width"), o = this.get("height"),
                        s = new u({start: {x: r, y: e}, end: {x: a - n, y: o - i}});
                    ...
                    var e = this, n = e.get("coord"), i = e.getXScale(), r = e.getYScales()[0], a = i.field,
                        o = i.scale(t[a]), s = r.field, c = r.scale(t[s]);
                    return n.convertPoint({x: o, y: c})
                }, n.getRecord = function (t) {
                    var e = this, n = e.get("coord"), i = e.getXScale(), r = e.getYScales()[0], a = n.invertPoint(t),
                        o = {};
                    ...
                    var e = this.get("width"), n = this.get("height"), i = {x: t[3], y: t[0]},
                        r = {x: e - t[1], y: n - t[2]}, a = this.get("plot"), o = this.get("coord");
        ...
        var i = n(5), r = Array.isArray ? Array.isArray : function (t) {
            return i(t, "Array")
        };
        t.exports = r
    }, function (t, e, n) {
        ...
        var i = n(33), r = Array.isArray ? Array.isArray : function (t) {
            return i(t, "Array")
        };
        t.exports = r
    }, function (t, e, n) {
        ...
        var r = n(73), a = function () {
            ...
            }, t.prototype.processAdjust = function () {
            }, t
        }();
        t.exports = a
    }, function (t, e) {
        ...
        var n = {
            multiply: function (t, e) {
                ...
                var i = Math.cos(n), r = Math.sin(n), a = e[0] * i + e[2] * r, o = e[1] * i + e[3] * r,
                    s = e[0] * -r + e[2] * i, c = e[1] * -r + e[3] * i;
        ...
        var i = n(0), r = n(1), a = n(3), o = function () {
            function t(t) {
            ...
            return e._initDefaultCfg = function () {
                ...
                i.each(n, function (n) {
                    var r = t.getContainer(n.get("top")), a = t.getOffsetPoint(n.get("value")),
                        o = t.getSidePoint(a, e), s = o.x, c = o.y;
                    n.attr(i.mix({
                        x: s,
                        y: c
                ...
                var e = this, n = e.gridPoints, o = e.ticks, s = t, c = n.length;
                i.each(n, function (n, u) {
                    ...
                    if (s) {
                        var h, f = s.type, p = n.points, g = e.getContainer(s.top);
                        if ("arc" === f) {
                            var d = e.center, v = e.startAngle, y = e.endAngle,
                                m = a.length([p[0].x - d.x, p[0].y - d.y]);
                            h = g.addShape("Arc", {
                                className: "axis-grid",
                                attrs: i.mix({x: d.x, y: d.y, startAngle: v, endAngle: y, r: m}, s)
                            })
                        } else h = g.addShape("Polyline", {className: "axis-grid", attrs: i.mix({points: p}, s)});
                        h._id = n._id
                    }
                })
                ...
                var n = this, i = n.getAxisVector(t), r = a.normalize([], i), o = n.offsetFactor,
                    s = [-1 * r[1] * o, r[0] * o];
                return a.scale([], s, e)
        ...
        var r = n(0), a = n(22), o = n(3), s = n(86),
            ...
            l = ["circle", "sector", "polygon", "rect", "polyline"], h = function () {
                function t(t) {
                ...
                return e._initProperties = function () {
                    ...
                    var e = this._attrs.attrs;
                    if (!this._attrs.isGroup) for (var n in e) if (u.indexOf(n) > -1) {
                        var i = e[n];
        ...
        t.exports = {
            getClip: function (t) {
                ...
                if (t.isPolar) {
                    ...
                    e = new i.Sector({attrs: {x: c.x, y: c.y, r: s, r0: 0, startAngle: u, endAngle: l}})
        ...
        var r = n(0), a = n(25), o = n(35), s = n(3), c = function (t) {
            function e() {
                return t.apply(this, arguments) || this
            }
            ...
            return n._initProperties = function () {
                ...
                for (var t = 1 / 0, e = -1 / 0, n = 1 / 0, i = -1 / 0, r = this.get("children"), a = 0, o = r.length; a < o; a++) {
                    ...
                    if (c.get("visible")) {
                        var u = c.getBBox();
                        if (!u) continue;
                        var l = [u.minX, u.minY], h = [u.minX, u.maxY], f = [u.maxX, u.minY], p = [u.maxX, u.maxY],
                            g = c.attr("matrix");
        ...
        function r(t, e, n, i) {
            ...
            if (r.length && a.isArray(r[0].y)) {
                ...
                return t.isInCircle && (o.push(o[0]), c.push(c[0])), t.isStack ? e.addShape("Polyline", {
                    ...
                    className: "line",
                    attrs: a.mix({points: o, smooth: i}, n)
                }), e.addShape("Polyline", {className: "line", attrs: a.mix({points: c, smooth: i}, n)})]
            }
            return t.isInCircle && r.push(r[0]), e.addShape("Polyline", {
                className: "line",
                attrs: a.mix({points: r, smooth: i}, n)
            })
        }

        var a = n(0), o = n(6), s = n(16), c = n(1), u = o.registerFactory("line", {defaultShapeType: "line"}),
            l = ["line", "smooth", "dash"];
        a.each(l, function (t) {
        ...
        var i = n(103), r = Array.isArray ? Array.isArray : function (t) {
            return i(t, "Array")
        };
        t.exports = r
    }, function (t, e, n) {
        ...
        var o = n(10), s = n(40), c = n(11), u = n(14), l = n(27), h = function (t) {
            function e() {
            ...
            return a(e, t), e.prototype._initDefaultCfg = function () {
                ...
                if (c(e, function (t, n) {
                    ...
                    var i = e;
                    n && (i = s({maxCount: n, data: e, isRounding: t.isRounding}).ticks), this.ticks = i
                }
                ...
                var e = this.rangeMin(), n = this.rangeMax(), i = void 0;
        ...
        var a = n(11);
        t.exports = function (t) {
            var e = {}, n = [], a = t.isRounding, o = i(t.data), s = o.length, c = t.maxCount || 8, u = void 0;
            if (a ? 2 === (u = r(s - 1, c - 1) + 1) ? u = c : u < c - 4 && (u = c - 4) : u = c, !a && s <= u + u / 2) n = [].concat(o); else {
        ...
        function r(t, e, n, r) {
            ...
            for (p = 0, h = t.length; p < h; p++) {
                ...
                var v = a.sub([], s, o);
                a.scale(v, v, e);
                var y = a.distance(l, o), m = a.distance(l, s), x = y + m;
                0 !== x && (y /= x, m /= x);
                var _ = a.scale([], v, -y), S = a.scale([], v, m), b = a.add([], l, _), w = a.add([], l, S);
        ...
        var s = function (t) {
            ...
            return n.getDefaultCfg = function () {
                ...
                var n = this, i = n.get("container"), r = n.getYScale(), s = n.get("connectNulls"),
                    c = a.splitArray(t, r.field, s), u = this.getDrawCfg(t[0]);
        ...
        var i = n(1), r = n(0), a = {
            getDefalutSize: function () {
                ...
                if (!t) {
                    var e = this.get("coord"), n = this.getXScale(), r = this.get("dataArray"), a = n.values.length,
                        o = n.range, s = 1 / a, c = 1;
                ...
                var e = this.get("coord"), n = e.convertPoint({x: 0, y: 0}),
                    i = e.convertPoint({x: "x" === t ? 1 : 0, y: "x" === t ? 0 : 1}), r = 0;
        ...
        var o = ["touchstart", "touchmove", "touchend"], s = function () {
            function t(t, e) {
            ...
            return e.getDefaultCfg = function () {
                ...
                this._clearEvents();
                var t = this.startEvent, e = this.processEvent, n = this.endEvent, r = this.resetEvent, a = this.el;
                ...
                var t = this.startEvent, e = this.processEvent, n = this.endEvent, i = this.resetEvent;
        ...
        function i(t, e) {
            var i = t.type, a = {}, o = t.targetTouches;
            o && o.length > 0 ? (a.x = o[0].clientX, a.y = o[0].clientY) : (a.x = t.clientX, a.y = t.clientY);
            var s = e.get("canvas"), c = r.getRelativePosition(a, s);
        ...
        r = {
            ...
            getRelativePosition: function (t, e) {
                var n = e.get("el"), i = n.getBoundingClientRect(), r = i.top, a = i.right, o = i.bottom, s = i.left,
                    c = parseFloat(this.getStyle(n, "padding-left")), u = parseFloat(this.getStyle(n, "padding-top")),
                    l = a - s - c - parseFloat(this.getStyle(n, "padding-right")),
                    h = o - r - u - parseFloat(this.getStyle(n, "padding-bottom")), f = e.get("pixelRatio");
                return {x: (t.x - s - c) / l * n.width / f, y: (t.y - r - u) / h * n.height / f}
            },
        ...
        var i = n(0), r = function () {
            ...
            return e._init = function () {
                var t = this, e = t.start, n = t.end, i = Math.min(e.x, n.x), r = Math.max(e.x, n.x),
                    a = Math.min(e.y, n.y), o = Math.max(e.y, n.y);
                this.tl = {x: i, y: a}, this.tr = {x: r, y: a}, this.bl = {x: i, y: o}, this.br = {
                    x: r,
                    y: o
        ...
        var r = n(18), a = function (t) {
            ...
            return n._initDefaultCfg = function () {
                ...
                return {x: a.start + (a.end - a.start) * t[i], y: o.start + (o.end - o.start) * t[r]}
        ...
        var o = n(65), s = n(19), c = n(34), u = function (t) {
            function e(n) {
                i(this, e);
            ...
            return a(e, t), e.prototype.mapping = function (t, e) {
                var n = this.scales, i = this.coord, r = n[0], a = n[1], u = void 0, l = void 0, h = void 0;
                if (o(t) || o(e)) return [];
                if (s(e) && s(t)) {
                    u = [], l = [];
        ...
        function o(t, e) {
            var n = t.length - 1, a = Math.floor(n * e), o = n * e - a, s = t[a], c = a === n ? s : t[a + 1];
        ...
        var i = n(0), r = n(1), a = n(75), o = {linear: "Linear", cat: "Cat", timeCat: "TimeCat", identity: "Identity"},
            s = function () {
                function t(t) {
                ...
                return e._getDef = function (t) {
                    ...
                    var r = "linear", a = i.Array.firstValue(e, t);
                    return i.isArray(a) && (a = a[0]), i.isString(a) && (r = "cat"), r
                }, e._getScaleCfg = function (t, e, n, r) {
                    var a, o = {field: e, values: a = r && r.values ? r.values : i.Array.values(n, e)};
                    if (!("cat" === t || "timeCat" === t || r && r.min && r.max)) {
                        var s = i.Array.getRange(a), c = s.min, u = s.max;
        ...
        var i = n(13), r = Array.isArray ? Array.isArray : function (t) {
            return i(t, "Array")
        };
        t.exports = r
    }, function (t, e, n) {
        ...
        var o = n(21), s = n(11), c = n(10), u = n(79), l = function (t) {
            function e() {
                return i(this, e), r(this, t.apply(this, arguments))
            }
            ...
            return a(e, t), e.prototype._initDefaultCfg = function () {
                ...
                var t = this.min, e = this.max, n = this.minLimit, i = this.maxLimit, r = this.tickCount,
                    a = this.tickInterval, o = this.minTickInterval, s = this.snapArray;
        ...
        var i = n(21), r = n(14), a = n(80), o = [0, 1, 1.2, 1.5, 1.6, 2, 2.2, 2.4, 2.5, 3, 4, 5, 6, 7.5, 8, 10],
            s = [0, 1, 2, 4, 5, 10];
        t.exports = function (t) {
            var e = t.min, n = t.max, c = t.interval, u = t.minTickInterval, l = [], h = t.minCount || 5,
                f = t.maxCount || 7, p = h === f, g = i(t.minLimit) ? -1 / 0 : t.minLimit,
                d = i(t.maxLimit) ? 1 / 0 : t.maxLimit, v = (h + f) / 2, y = v,
            ...
            if (r(u) && c < u && (c = u), t.interval || f !== h) n = Math.min(a.snapMultiple(n, c, "ceil"), d), e = Math.max(a.snapMultiple(e, c, "floor"), g), y = Math.round((n - e) / c), e = a.fixedBase(e, c), n = a.fixedBase(n, c); else {
                v = parseInt(v, 10);
                var _ = (n + e) / 2, S = a.snapMultiple(_, c, "ceil"), b = Math.floor((v - 2) / 2), w = S + b * c,
                    P = void 0;
        ...
        var o = n(10), s = n(14), c = function (t) {
            function e() {
                return i(this, e), r(this, t.apply(this, arguments))
            }
        ...
        var r = n(0), a = n(83), o = n(1), s = n(7).Shape, c = function () {
            function t(t) {
            ...
            return e._isHide = function (t) {
                ...
                var i, r, a = 1;
                return "x" === e ? (i = {x: 0, y: 0}, r = {x: 1, y: 0}) : "right" === n ? (i = {x: 1, y: 0}, r = {
                    x: 1,
                    y: 1
                }) : (i = {x: 0, y: 0}, r = {x: 0, y: 1}, a = -1), t.transposed && (a *= -1), {
                    offsetFactor: a,
                ...
                var e, n;
                return t.transposed ? (e = {x: 0, y: 0}, n = {x: 1, y: 0}) : (e = {x: 0, y: 0}, n = {
                    x: 0,
                    y: 1
                }), {offsetFactor: -1, start: t.convertPoint(e), end: t.convertPoint(n)}
            }, e._getAxisCfg = function (t, e, n, i, a) {
                var c = this, u = this.axisCfg, l = e.getTicks(), h = r.deepMix({
                    ticks: l,
                    frontContainer: this.frontPlot,
                    backContainer: this.backPlot
                }, a, u[e.field]), f = [], p = h.label, g = l.length, d = 0, v = 0, y = p;
                ...
                var s = this.axes, c = o.chart;
                if (c._isAutoPadding()) {
                    var u = r.parsePadding(c.get("padding")), l = r.parsePadding(c.get("appendPadding")),
                    ...
                    if (t.isPolar) {
                        ...
                        if (s.right && "auto" === u[1]) {
                            var y = s.right, m = y.maxWidth, x = y.labelOffset;
                            f[1] += m + x
                        }
                        if (s.left && "auto" === u[3]) {
                        ...
                        if (s.bottom && "auto" === u[2]) {
                            var w = s.bottom, P = w.maxHeight, C = w.labelOffset;
                            f[2] += P + C
                        }
                    }
                ...
                r.each(s, function (e) {
                    var n, s = e.type, c = e.grid, u = e.verticalScale, l = e.ticks, h = e.dimType, f = e.position,
                        p = e.index;
                    if (t.isPolar ? "Line" === s ? n = o._getRadiusCfg(t) : "Circle" === s && (n = o._getCircleCfg(t)) : n = o._getLineCfg(t, h, f), c && u) {
                        var g = [], d = i(u.getTicks());
                        r.each(l, function (e) {
                            var n = [];
                            r.each(d, function (i) {
        ...
        var r = n(0), a = n(24), o = function (t) {
            ...
            return n._initDefaultCfg = function () {
                ...
                e.addShape("line", {className: "axis-line", attrs: r.mix({x1: n.x, y1: n.y, x2: i.x, y2: i.y}, t)})
            }, e
        }(a);
        a.Line = o, t.exports = o
    }, function (t, e, n) {
        var i = n(0), r = n(35), a = n(36), o = n(41).requestAnimationFrame, s = function () {
            function t(t) {
        ...
        function r(t, e, n) {
            ...
            a = a * Math.PI / 180;
            var o, s, c = r.slice(1), u = e.getBBox(), l = u.minX, h = u.minY, f = u.maxX, p = u.maxY;
            a >= 0 && a < .5 * Math.PI ? (o = {x: l, y: h}, s = {
                x: f,
                y: p
            }) : .5 * Math.PI <= a && a < Math.PI ? (o = {x: f, y: h}, s = {
                x: l,
                y: p
            }) : Math.PI <= a && a < 1.5 * Math.PI ? (o = {x: f, y: p}, s = {x: l, y: h}) : (o = {
                x: l,
                y: p
            }, s = {x: f, y: h});
            var g = Math.tan(a), d = g * g, v = (s.x - o.x + g * (s.y - o.y)) / (d + 1) + o.x,
                y = g * (s.x - o.x + g * (s.y - o.y)) / (d + 1) + o.y, m = n.createLinearGradient(o.x, o.y, v, y);
            return i(c, m), m
        }
        ...
        function a(t, e, n) {
            var r = t.split(" "), a = r[0].slice(2, r[0].length - 1);
            a = a.split(",");
            var o = parseFloat(a[0]), s = parseFloat(a[1]), c = parseFloat(a[2]), u = r.slice(1);
            if (0 === c) return u[u.length - 1].split(":")[1];
            var l = e.getBBox(), h = l.width, f = l.height, p = l.minX, g = l.minY, d = Math.sqrt(h * h + f * f) / 2,
        ...
        var r = n(0), a = n(2), o = function (t) {
            ...
            return n._initProperties = function () {
                ...
                var e = this.get("attrs"), n = e.x, i = e.y, a = e.width, o = e.height;
                t.beginPath();
                var s = e.radius;
        ...
        var r = n(2), a = n(8), o = function (t) {
            ...
            return n._initProperties = function () {
                ...
                var t = this.get("attrs"), e = t.x1, n = t.y1, i = t.x2, r = t.y2;
        ...
        var r = n(2), a = n(42), o = n(8), s = function (t) {
            function e() {
                return t.apply(this, arguments) || this
            }
            ...
            return n._initProperties = function () {
                ...
                var t = this.get("attrs"), e = t.points;
                if (t.smooth) {
                    for (var n = [], i = [[0, 0], [1, 1]], r = a.smooth(e, !1, i), s = 0, c = r.length; s < c; s++) {
                        var u = r[s];
                        if (0 === s) n.push([e[0].x, e[0].y, u[1], u[2], u[3], u[4], u[5], u[6]]); else {
                            var l = r[s - 1];
        ...
        var r = n(2), a = n(8), o = function (t) {
            ...
            return n._initProperties = function () {
                ...
                var e = this.get("attrs"), n = e.x, i = e.y, r = e.r, a = e.startAngle, o = e.endAngle, s = e.clockwise;
                t.beginPath(), t.arc(n, i, r, a, o, s)
            }, n.calculateBox = function () {
                var t = this.get("attrs"), e = t.x, n = t.y, i = t.r, r = t.startAngle, o = t.endAngle, s = t.clockwise;
        ...
        var r = n(2), a = n(8), o = function (t) {
            ...
            return n._initProperties = function () {
                ...
                var e = this.get("attrs"), n = e.x, i = e.y, r = e.startAngle, a = e.endAngle, o = e.r, s = e.r0,
                    c = e.clockwise;
                t.beginPath();
                ...
                var t = this.get("attrs"), e = t.x, n = t.y, i = t.r, r = t.r0, o = t.startAngle, s = t.endAngle,
                    c = t.clockwise, u = a.getBBoxFromArc(e, n, i, o, s, c), l = a.getBBoxFromArc(e, n, r, o, s, c);
                return {
        ...
        var r = n(0), a = n(2), o = 0, s = {}, c = function (t) {
            function e() {
                return t.apply(this, arguments) || this
            }
            ...
            return n._initProperties = function () {
                ...
                var e = this, n = e._attrs.attrs, i = n.text, a = n.x, o = n.y;
                ...
                var t = this, e = t._attrs.attrs, n = e.x, i = e.y, r = e.textAlign, a = e.textBaseline,
                    o = t._getTextWidth();
                if (!o) return {minX: n, minY: i, maxX: n, maxY: i};
                var s = t._getTextHeight(), c = {x: n, y: i - s};
                ...
                if (!r.isNil(e)) {
                    var i = t.font, a = t.textArr, c = e + "" + i;
                    if (s[c]) return s[c];
                    var u = 0;
        ...
        function i(t) {
            var e = t.x, n = t.y, i = t.y0, r = t.size, o = i, s = n;
            a.isArray(n) && (s = n[1], o = n[0]);
            var c, u;
            return a.isArray(e) ? (c = e[0], u = e[1]) : (c = e - r / 2, u = e + r / 2), [{x: c, y: o}, {
                x: c,
                y: s
            }, {x: u, y: s}, {x: u, y: o}]
        }
        ...
        function r(t) {
            ...
            return {x: o, y: s, width: Math.max.apply(null, e) - o, height: Math.max.apply(null, n) - s}
        }

        var a = n(0), o = n(6), s = n(3), c = n(1), u = o.registerFactory("interval", {
            defaultShapeType: "rect", getDefaultPoints: function (t) {
                return i(t)
            }
        });
        o.registerShape("interval", "rect", {
            draw: function (t, e) {
                var n = this.parsePoints(t.points), i = a.mix({fill: t.color}, c.shape.interval, t.style);
                if (t.isInCircle) {
                    var o = n.slice(0);
                    this._coord.transposed && (o = [n[0], n[3], n[2], n[1]]);
                    var u = t.center, l = u.x, h = u.y, f = [1, 0], p = [o[0].x - l, o[0].y - h],
                        g = [o[1].x - l, o[1].y - h], d = [o[2].x - l, o[2].y - h], v = s.angleTo(f, g),
                        y = s.angleTo(f, d), m = s.length(p), x = s.length(g);
                    return v >= 1.5 * Math.PI && (v -= 2 * Math.PI), y >= 1.5 * Math.PI && (y -= 2 * Math.PI), e.addShape("Sector", {
                        className: "interval",
                        attrs: a.mix({x: l, y: h, r: x, r0: m, startAngle: v, endAngle: y}, i)
                    })
                }
                var _ = r(n);
        ...
        var o = n(38), s = n(104), c = n(20), u = function (t) {
            function e() {
                return i(this, e), r(this, t.apply(this, arguments))
            }
            ...
            return a(e, t), e.prototype._initDefaultCfg = function () {
                ...
                var e = this, n = e.xField, i = e.yField, r = t.length, a = {positive: {}, negative: {}};
                e.reverseOrder && (t = t.slice(0).reverse());
                for (var c = 0; c < r; c++) for (var u = t[c], l = 0, h = u.length; l < h; l++) {
                    var f = u[l], p = f[n] || 0, g = f[i], d = p.toString();
                    if (g = o(g) ? g[1] : g, !s(g)) {
        ...
        var o = n(20), s = n(107), c = function (t) {
            function e() {
                return i(this, e), r(this, t.apply(this, arguments))
            }
            ...
            return a(e, t), e.prototype._initDefaultCfg = function () {
                ...
                var i = this, r = t.pre, a = t.next, o = a - r, s = o * i.dodgeRatio / n, c = i.marginRatio * s;
                return (r + a) / 2 + (.5 * (o - n * s - (n - 1) * c) + ((e + 1) * s + e * c) - .5 * s - .5 * o)
            }, e.prototype.processAdjust = function (t) {
                var e = this, n = t.length, i = e.xField;
                s(t, function (t, r) {
                    for (var a = 0, o = t.length; a < o; a++) {
                        var s = t[a], c = s[i], u = {pre: c - .5, next: c + .5}, l = e.getDodgeOffset(u, r, n);
                        s[i] = l
                    }
                })
            }, e
        ...
        var r = n(18), a = n(3), o = n(22), s = function (t) {
            function e() {
                return t.apply(this, arguments) || this
            }
            ...
            return n._initDefaultCfg = function () {
                ...
                var n, i, r = this, a = r.inner || r.innerRadius, o = Math.abs(e.x - t.x), s = Math.abs(e.y - t.y);
                r.startAngle === -Math.PI && 0 === r.endAngle ? (n = Math.min(o / 2, s), i = {
                    x: (t.x + e.x) / 2,
                    y: t.y
                }) : (n = Math.min(o, s) / 2, i = {x: (t.x + e.x) / 2, y: (t.y + e.y) / 2});
                var c = r.radius;
                c > 0 && c <= 1 && (n *= c), this.x = {start: r.startAngle, end: r.endAngle}, this.y = {
                    start: n * a,
                    end: n
                }, this.center = i, this.circleRadius = n
            }, n.convertPoint = function (t) {
                var e = this, n = e.center, i = e.transposed, r = i ? "y" : "x", a = i ? "x" : "y", o = e.x, s = e.y,
                    c = o.start + (o.end - o.start) * t[r], u = s.start + (s.end - s.start) * t[a];
                return {x: n.x + Math.cos(c) * u, y: n.y + Math.sin(c) * u}
            }, n.invertPoint = function (t) {
                var e = this, n = e.center, i = e.transposed, r = e.x, s = e.y, c = i ? "y" : "x", u = i ? "x" : "y",
                    l = [1, 0, 0, 1, 0, 0];
        ...
        var r = n(0), a = {
            ...
            return n._initProperties = function () {
                ...
                var e, n = this.get("attrs"), i = n.x, o = n.y, s = n.radius, c = n.symbol || "circle";
        ...
        var i = n(0), r = n(7).Group, a = n(111), o = function () {
            function t(t) {
            ...
            return e.getDefaultCfg = function () {
                ...
                if (t) {
                    var e = this.container, n = this.wrapper.getBBox(), r = n.minX, a = n.minY, o = n.width,
                        s = n.height, c = t.padding || [0, 0, 0, 0];
                    c = i.parsePadding(c);
                    var u = i.mix({x: r - c[3], y: a - c[0], width: o + c[1] + c[3], height: s + c[0] + c[2]}, t),
                        l = this.backShape;
                    l ? l.attr(u) : l = e.addShape("Rect", {zIndex: -1, attrs: u}), this.backShape = l, e.sort()
                }
                ...
                var e = this.itemsGroup.addGroup({
                        ...
                        checked: t.checked
                    }), n = this.unCheckStyle, r = this.unCheckColor, o = this.nameStyle, s = this.valueStyle,
                    c = this.wordSpace, u = t.marker, l = t.value, h = 0;
                if (r && (n.fill = r), u) {
                    var f = u.radius || 3, p = i.mix({x: f, y: this._titleHeight}, u);
                ...
                if (l) {
                    ...
                    d && (m += d.getBBox().width), e.addShape("text", {
                        className: "value",
                        attrs: i.mix({x: m, y: this._titleHeight, text: l}, s, !1 === t.checked ? n : null)
                    })
                }
                return e
                ...
                for (var t, e, n = this.maxLength, i = this.itemsGroup.get("children"), r = this.itemGap, a = this.itemMarginBottom, o = this._titleHeight, s = 0, c = 0, u = this._getMaxItemWidth(), l = [], h = 0, f = i.length; h < f; h++) {
                    var p = i[h], g = p.getBBox(), d = g.height, v = g.width;
        ...
        var i = n(0), r = {
            ...
            defaultCfg: {}, Action: {}, getAnimation: function (t, e, n) {
        ...
        var i = n(7).Matrix, r = n(0), a = {
            getCoordInfo: function (t) {
                ...
                if ("x" === n) {
                    ...
                    var c = t.getMatrix();
                    r = i.transform(c, [["t", a, o], ["s", 1, 100], ["t", -a, -o]])
                } else if ("xy" === n) {
                    t.transform([["t", a, o], ["s", .01, .01], ["t", -a, -o]]);
                    var u = t.getMatrix();
                    r = i.transform(u, [["t", a, o], ["s", 100, 100], ["t", -a, -o]])
                }
                return r
                ...
                var r = t._id, o = t.get("index"), s = a.getAnimateParam(n, o, r), c = s.easing, u = s.delay,
                    l = s.duration, h = t.animate().to({attrs: e, duration: l, delay: u, easing: c});
                i && h.onEnd(function () {
                    i()
                })
            }
        ...
        var o = function (t) {
            ...
            return n.getDefaultCfg = function () {
                ...
                r.each(t, function (t) {
                    var a = t.shape, o = n.getDrawCfg(t);
                    if (r.isArray(t.y)) {
        ...
        function r(t, e, n) {
            if (0 !== t.size) {
                var r = i(t), o = r.r || r.size, s = t.x, c = a.isArray(t.y) ? t.y : [t.y];
                "hollowCircle" === n && (r.lineWidth = 1, r.fill = null);
                for (var u = 0, l = c.length; u < l; u++) return "rect" === n ? e.addShape("Rect", {
                    className: "point",
                    attrs: a.mix({x: s - o, y: c[u] - o, width: 2 * o, height: 2 * o}, r)
                }) : e.addShape("Circle", {className: "point", attrs: a.mix({x: s, y: c[u], r: o}, r)})
            }
        }

        var a = n(0), o = n(1), s = n(16), c = n(6), u = ["circle", "hollowCircle", "rect"],
            l = c.registerFactory("point", {
                defaultShapeType: "circle", getDefaultPoints: function (t) {
        ...
        var s = function (t) {
            ...
            return n.getDefaultCfg = function () {
                ...
                var n = this, i = n.get("container"), r = this.getDrawCfg(t[0]), s = n.getYScale(),
                    c = n.get("connectNulls"), u = a.splitArray(t, s.field, c);
        ...
        function a(t, e, n, i, r) {
            ...
            return r ? n.addShape("Custom", {
                className: "area", attrs: s.mix({points: a}, i), createPath: function (t) {
                    var e = [[0, 0], [1, 1]], n = this._attrs.attrs.points, i = n.length, r = n.slice(0, i / 2),
                        a = n.slice(i / 2, i), o = u.smooth(r, !1, e);
        ...
        function o(t, e, n) {
            var i = this, o = t.points, c = [], u = [];
            s.each(o, function (t) {
                u.push(t[0]), c.push(t[1])
            });
            var l = s.mix({fillStyle: t.color}, h.shape.area, t.style);
        ...
        var s = n(0), c = n(6), u = n(42), l = n(8), h = n(1), f = c.registerFactory("area", {
            defaultShapeType: "area", getDefaultPoints: function (t) {
        ...
        var o = function (t) {
            ...
            return n.getDefaultCfg = function () {
                ...
                var n, i = t.prototype.createShapePointsCfg.call(this, e), r = this, o = i.x, s = i.y;
                if (!a.isArray(o) || !a.isArray(s)) {
                    var c = r.getXScale(), u = r.getYScale(), l = .5 / (c.values ? c.values.length : c.ticks.length),
        ...
        var i = n(6), r = n(0), a = i.registerFactory("polygon", {
            defaultShapeType: "polygon", getDefaultPoints: function (t) {
                for (var e = [], n = t.x, i = t.y, r = 0, a = n.length; r < a; r++) e.push({x: n[r], y: i[r]});
                return e
            }
        });
        i.registerShape("polygon", "polygon", {
            draw: function (t, e) {
                var n = this.parsePoints(t.points), i = r.mix({fill: t.color, points: n}, t.style);
        ...
        function r(t, e, n) {
            var r = i(e);
            return [{x: t, y: r[0]}, {x: t, y: r[1]}, {x: t - n / 2, y: r[2]}, {x: t - n / 2, y: r[1]}, {
                x: t + n / 2,
                y: r[1]
            }, {x: t + n / 2, y: r[2]}, {x: t, y: r[2]}, {x: t, y: r[3]}]
        }

        var a = n(6), o = n(0), s = a.registerFactory("schema", {});
        a.registerShape("schema", "candle", {
            getPoints: function (t) {
                return r(t.x, t.y, t.size)
            }, draw: function (t, e) {
                var n = this.parsePoints(t.points), i = o.mix({stroke: t.color, fill: t.color, lineWidth: 1}, t.style);
                return e.addShape("Custom", {
                    className: "schema", attrs: i, createPath: function (t) {
        ...
        var r = n(0), a = n(24), o = function (t) {
            ...
            return n._initDefaultCfg = function () {
                ...
                var e = this.center, n = this.radius, i = this.startAngle, a = this.endAngle;
        ...
        var o = n(10), s = n(39), c = n(127), u = n(40), l = n(110), h = n(11), f = n(14), p = n(23), g = n(27),
            d = function (t) {
                function e() {
                    return i(this, e), r(this, t.apply(this, arguments))
                }
                ...
                return a(e, t), e.prototype._initDefaultCfg = function () {
                    ...
                    return e ? u({maxCount: e, data: t.values, isRounding: t.isRounding}).ticks : t.values
                }, e.prototype.translate = function (t) {
                    t = this._toTimeStamp(t);
                    var e = this.values.indexOf(t);
                    return -1 === e && (e = f(t) && t < this.values.length ? t : NaN), e
                }, e.prototype.scale = function (t) {
                    var e = this.rangeMin(), n = this.rangeMax(), i = this.translate(t), r = void 0;
                    ...
                    var t = this, e = this.ticks, n = [];
                    return h(e, function (e) {
                        var i = void 0;
                        i = p(e) ? e : {text: g(e) ? e : t.getText(e), value: t.scale(e), tickValue: e}, n.push(i)
                    }), n
        ...
        !function (r) {
            ...
            var c = {}, u = /d{1,4}|M{1,4}|YY(?:YY)?|S{1,3}|Do|ZZ|([HhMsDm])\1?|[aA]|"[^"]*"|'[^']*'/g, l = /\d\d?/,
                h = /\d{3}/, f = /\d{4}/,
        ...
        var r = n(0), a = n(9), o = function (t) {
            ...
            return n._initDefaultCfg = function () {
                ...
                var n = this, i = n.parsePoint(t, n.start), a = n.parsePoint(t, n.end);
                if (i && a) {
                    var o = t.center, s = Math.sqrt((i.x - o.x) * (i.x - o.x) + (i.y - o.y) * (i.y - o.y)),
                        c = Math.atan2(i.y - o.y, i.x - o.x), u = Math.atan2(a.y - o.y, a.x - o.x),
                        l = e.addShape("arc", {
                            className: "guide-arc",
                            attrs: r.mix({x: o.x, y: o.y, r: s, startAngle: c, endAngle: u}, n.style)
                        });
        ...
        var s = n(0), c = n(9), u = function (t) {
            ...
            return n._initDefaultCfg = function () {
                ...
                if (i) {
                    ...
                    var u = e.get("canvas").get("el"), l = u.parentNode;
                    ...
                    var f = u.offsetTop, p = u.offsetLeft, g = n.alignX, d = n.alignY, v = n.offsetX, y = n.offsetY,
        ...
        var r = n(0), a = n(9), o = function (t) {
            ...
            return n._initDefaultCfg = function () {
                ...
                if (i) {
                    var a = this.content, o = this.style, s = this.offsetX, c = this.offsetY;
                    s && (i.x += s), c && (i.y += c);
                    var u = e.addShape("text", {className: "guide-text", attrs: r.mix({x: i.x, y: i.y, text: a}, o)});
        ...
        var r = n(0), a = n(9), o = function (t) {
            ...
            return n._initDefaultCfg = function () {
                this.type = "tag", this.position = null, this.content = null, this.direct = "tl", this.autoAdjust = !0, this.offsetX = 0, this.offsetY = 0, this.side = 4, this.background = {
                    ...
                    textAlign: "center",
                    textBaseline: "middle"
                }, this.withPoint = !0, this.pointStyle = {fill: "#1890FF", r: 3, lineWidth: 1, stroke: "#fff"}
            }, n._getDirect = function (t, e, n, i) {
                var r = this.direct, a = this.side, o = t.get("canvas"), s = o.get("width"), c = o.get("height"),
                    u = e.x, l = e.y, h = r[0], f = r[1];
                ...
                if (n) {
                    var i = this.content, a = this.background, o = this.textStyle, s = [],
                    ...
                    var l = c.addGroup(), h = l.addShape("text", {
                        className: "guide-tag-text",
                        zIndex: 1,
                        attrs: r.mix({x: 0, y: 0, text: i}, o)
                    });
                    s.push(h);
                    var f = h.getBBox(), p = r.parsePadding(a.padding), g = f.width + p[1] + p[3],
                        d = f.height + p[0] + p[2], v = f.minY - p[0], y = f.minX - p[3], m = l.addShape("rect", {
                            className: "guide-tag-bg",
                            zIndex: -1,
                            attrs: r.mix({x: y, y: v, width: g, height: d}, a)
                        });
                    s.push(m);
                    var x, _ = this.autoAdjust ? this._getDirect(e, n, g, d) : this.direct, S = this.side,
                        b = n.x + this.offsetX, w = n.y + this.offsetY, P = r.parsePadding(a.radius);
                    "tl" === _ ? (x = [{x: g + y - S - 1, y: d + v - 1}, {x: g + y, y: d + v - 1}, {
                        x: g + y,
                        y: d + S + v
                        ...
                        x: g + S + y,
                        y: d / 2 + v
                    }], b = b - g - S, w -= d / 2) : "bl" === _ ? (x = [{x: g + y, y: -S + v}, {
                        x: g + y - S - 1,
                        y: v + 1
                    }, {x: g + y, y: v + 1}], P[1] = 0, b -= g, w += S) : "bc" === _ ? (x = [{
                        x: g / 2 + y,
                        y: -S + v
                    }, {x: (g - S) / 2 + y - 1, y: v + 1}, {
                        x: (g + S) / 2 + y + 1,
                        y: v + 1
                    }], b -= g / 2, w += S) : "br" === _ ? (x = [{x: y, y: v - S}, {x: y, y: v + 1}, {
                        x: y + S + 1,
                        y: v + 1
                    }], P[0] = 0, w += S) : "cr" === _ ? (x = [{x: y - S, y: d / 2 + v}, {
                        x: y + 1,
                        y: (d - S) / 2 + v - 1
                    }, {x: y + 1, y: (d + S) / 2 + v + 1}], b += S, w -= d / 2) : "tr" === _ ? (x = [{
                        x: y,
                        y: d + S + v
                    }, {x: y, y: d + v - 1}, {
                        x: S + y + 1,
        ...
        var l = n(0), h = n(1), f = n(136), p = n(26);
        h.tooltip = l.deepMix({
            ...
            nameStyle: {fontSize: 12, fill: "rgba(255, 255, 255, 0.65)", textAlign: "start", textBaseline: "middle"},
        ...
        var g = function () {
            ...
            return e._setCrosshairsCfg = function () {
                ...
                return !n.length || "cartesian" !== r && "rect" !== r || 1 === i.length && -1 !== ["line", "area", "path", "point"].indexOf(i[0]) && l.mix(e, {showCrosshairs: !0}), e
                ...
                var t = this;
                if (!t.tooltip) {
                    var e = t.chart, n = e.get("canvas"),
                        i = e.get("frontPlot").addGroup({className: "tooltipContainer", zIndex: 10}),
                        r = e.get("backPlot").addGroup({className: "tooltipContainer"}), a = e.get("plotRange"),
                        o = e.get("coord"), s = t._setCrosshairsCfg(), c = t.cfg;
                    (c = l.deepMix({
                        plotRange: a,
                        frontPlot: i,
                        backPlot: r,
                ...
                void 0 === t && (t = {});
                var e = t, n = e.type, i = e.items, r = this.cfg;
                if ("rect" === n) {
                    var a, o, s, c, u = this.chart, h = u.get("plotRange"), f = h.tl, p = h.br, g = u.get("coord"),
                        d = i[0], v = i[i.length - 1], y = d.width;
                ...
                void 0 === n && (n = {});
                var i = this._lastActive, r = this.tooltip, a = this.cfg;
                    ...
                    if (i.get("visible")) {
                        ...
                        l.each(f, function (t) {
                            if (t.x && t.y) {
                                ...
                                n && (y.marker = l.mix({fill: v || h.defaultColor}, n)), u.push(y), -1 !== ["line", "area", "path"].indexOf(s) ? (e = "circle", c.push(y)) : "interval" !== s || "cartesian" !== g.type && "rect" !== g.type || (e = "rect", y.width = i.getSize(t._origin), c.push(y))
                            }
                        })
                    }
                }), u.length) {
                ...
                if (this.enable) {
                    var e = this.chart, n = e.get("plotRange"), i = l.createEvent(t, e);
                ...
                var t = this.cfg, e = t.triggerOn, n = t.triggerOff, i = t.alwaysShow,
                    r = l.wrapBehavior(this, "handleShowEvent"), a = l.wrapBehavior(this, "handleHideEvent");
                ...
                var t = this.cfg, e = t.triggerOn, n = t.triggerOff, i = t.alwaysShow,
                    r = l.getWrapBehavior(this, "handleShowEvent"), a = l.getWrapBehavior(this, "handleHideEvent");
        ...
        var i = n(0), r = n(111), a = n(112), o = function () {
            function t(t) {
                i.deepMix(this, this.getDefaultCfg(), t);
                var e = this.frontPlot, n = this.plotRange;
                if (!this.custom) {
                ...
                if (this.showCrosshairs) {
                    var o = this.crosshairsStyle, s = e.addShape("Line", {
            ...
            return e.getDefaultCfg = function () {
                ...
                var e = this.container, n = this.plotRange, r = this.offsetX, a = this.offsetY,
                    o = this.crosshairsShape, s = this.fixed, c = this.tooltipArrow;
                if (o && o.moveTo(t[0].x, 0), e) {
                    var u = e.container.getBBox(), l = u.minX, h = u.minY, f = u.width, p = u.height, g = n.tl,
                        d = n.tr, v = 0, y = g.y - p - 4 + a;
                    if (s) v = (g.x + d.x) / 2 - f / 2 + r; else {
                        var m;
                        if (m = t.length > 1 ? (t[0].x + t[t.length - 1].x) / 2 : t[0].x, (v = m - f / 2 + r) < g.x && (v = g.x), v + f > d.x && (v = d.x - f), c) {
                            c.attr("points", [{x: m - 3, y: g.y - 4 + a}, {x: m + 3, y: g.y - 4 + a}, {
                                x: m,
                                y: g.y + a
                            }]);
                            var x = e.backShape, _ = i.parsePadding(x.attr("radius"));
                            m === g.x ? (_[3] = 0, c.attr("points", [{x: g.x, y: g.y + a}, {
                                x: g.x,
                                y: g.y - 4 + a
                            }, {x: g.x + 4, y: g.y - 4 + a}])) : m === d.x && (_[2] = 0, c.attr("points", [{
                                x: d.x,
                                y: g.y + a
                            }, {x: d.x - 4, y: g.y - 4 + a}, {x: d.x, y: g.y - 4 + a}])), x.attr("radius", _)
                        }
                    }
                    e.moveTo(v - l, y - h)
                }
                ...
                void 0 === t && (t = {});
                var e = this, n = t, a = n.items, o = n.style, s = n.type, c = e._getMarkerGroup(s);
                if ("circle" === s) for (var u = 0, l = a.length; u < l; u++) {
                    var h = a[u], f = new r({
                ...
                var t = this.crosshairsShape, e = this.markerGroup, n = this.container, i = this.tooltipArrow,
                    r = this.canvas;
                ...
                return e ? e.clear() : ("circle" === t ? (e = this.frontPlot.addGroup({zIndex: 1}), this.frontPlot.sort()) : e = this.backPlot.addGroup(), this.markerGroup = e), e
            }, t
        }();
        t.exports = o
    }, function (t, e, n) {
        var i = n(0), r = n(9), a = n(1);
        a.guide = i.deepMix({
            ...
            point: {top: !0, offsetX: 0, offsetY: 0, style: {fill: "#fff", r: 3, lineWidth: 2, stroke: "#1890ff"}}
        }, a.guide || {});
        var o = function () {
            function t(t) {
        ...
        var c = function () {
            ...
            return e.addLegend = function (t, e, n) {
                ...
                var l = new a(r.deepMix({}, o.legend[i], n, {maxLength: e._getMaxLength(i), items: c, parent: u}));
                s[i].push(l)
            }, e.clear = function () {
                var t = this.legends;
                r.each(t, function (t) {
                ...
                var s = this, c = s.legendCfg, u = s.legends, l = s.container, h = s.chart, f = t.field;
                u[n] = u[n] || [];
                var p = "circle";
                ...
                var i = this, a = i.plotRange, o = a.tl, s = a.bl, c = i.chart, u = t.offsetX || 0, l = t.offsetY || 0,
                    h = c.get("width"), f = c.get("height"), p = r.parsePadding(c.get("appendPadding")),
                    g = t.getHeight(), d = t.getWidth(), v = 0, y = 0;
                if ("left" === n || "right" === n) {
                    var m = t.verticalAlign || "middle", x = Math.abs(o.y - s.y);
                ...
                var e = this, n = e.chart, i = r.createEvent(t, n), a = function (t, n) {
                    var i = null, a = e.legends;
                ...
                if (a && !1 !== a.clickedLegend.clickable) {
                    ...
                    if (s.onClick) t.clickedItem = o, s.onClick(t); else if (!s.custom) {
                        var c = o.get("checked"), u = o.get("dataValue"), l = s.filterVals, h = s.field;
        ...
        t.exports = {
            init: function (t) {
                ...
                var c = e.legends, u = {top: 0, right: 0, bottom: 0, left: 0};
        ...
        function r(t, e, n) {
            var i, r = t.get("type"), a = "geom" + n + "-" + r, o = t.getXScale(), s = t.getYScale(),
                c = o.field || "x", u = s.field || "y", l = e[u];
        ...
        function a(t, e, n) {
            ...
            return f.each(t, function (t, a) {
                var o = t.get("container").get("children"), s = t.get("type"),
        ...
        function u(t, e, n) {
            ...
            f.each(e, function (e) {
                ...
                var e = t.className, i = t.coord, o = t._id, u = t.attrs, l = t.index, h = t.type;
                if (!1 === (a = c(e, "leave", t.animateCfg))) return !0;
                if (r = s(e, i, "leave", a.animation), f.isFunction(r)) {
                    var p = n.addShape(h, {attrs: u, index: l, canvas: n, className: e});
                    p._id = o, r(p, a, i)
                }
            }), f.each(o, function (t) {
                var e = t.get("className");
                if (!1 === (a = c(e, "update", t.get("animateCfg")))) return !0;
                var n = t.get("coord"), o = t.get("cacheShape").attrs, u = i(o, t._attrs.attrs);
        ...
        var h, f = n(0), p = n(25), g = n(140), d = n(141), v = n(113), y = n(143), m = n(144), x = n(15);
        ...
        t.exports = {
            afterCanvasInit: function () {
                ...
                if (!1 !== t.get("animate")) {
                    var e = t.get("isUpdate"), n = t.get("canvas"), i = t.get("coord"), r = t.get("geoms"),
                        h = n.get("caches") || [];
                    0 === h.length && (e = !1);
                    var p = a(r, t, i), g = t.get("axisController"), d = g.frontPlot, y = g.backPlot,
                        x = d.get("children").concat(y.get("children")), S = [];
                    ...
                    if (x.concat(S).forEach(function (e) {
                        ...
                        f.each(r, function (e) {
                            ...
                            if (!1 !== r) if (w = c(n, "appear", r), P = s(n, i, "appear", w.animation), f.isFunction(P)) {
                                var a = e.get("shapes");
                                f.each(a, function (t) {
                                    P(t, w, i)
                                })
                                ...
                                var o = e.getYScale(), u = i.convertPoint({x: 0, y: o.scale(e.getYMinValue())}),
                                    h = e.get("container");
                                P && P(h, w, i, u)
                            }
                        }), f.each(b, function (t) {
                            ...
                            if (e && e.appear) {
                                var r = v.getAnimateCfg(n, "appear"), a = f.deepMix({}, r, e.appear),
        ...
        var i = n(41).requestAnimationFrame, r = "object" == typeof performance && performance.now ? performance : Date,
            a = function () {
                function t() {
                    ...
                    for (var e = 0; e < this.anims.length; e++) {
                        ...
                        if (!(t < n.startTime || n.hasEnded)) {
                            ...
                            if (i.get("destroyed")) this.anims.splice(e, 1), e--; else {
                                var a = n.startState, o = n.endState, s = n.interpolate, c = n.duration;
                                ...
                                var d = i.get("canvas");
                                -1 === this.canvas.indexOf(d) && this.canvas.push(d), n.onUpdate && n.onUpdate(u), t >= n.endTime && !n.hasEnded && (n.hasEnded = !0, n.onEnd && n.onEnd()), 1 === u && (this.anims.splice(e, 1), e--)
                            }
                        }
                    }
        ...
        var o = n(142), s = function () {
            ...
            return e.to = function (t) {
                ...
                var u = {shape: this.shape, startTime: this.timeline.time + n, duration: c, easing: e}, l = {};
                for (var h in s) {
        ...
        function i(t, e, n, i, r) {
            var o, c, u = a.getCoordInfo(n), l = u.start, h = u.end, f = u.width, p = u.height,
        ...
        function r(t, e, n) {
            for (var i, r, o, s = t.get("children"), c = 0, u = s.length; c < u; c++) {
                var l = s[c], h = l.getBBox();
                i = (h.minX + h.maxX) / 2, r = (h.minY + h.maxY) / 2, o = a.getScaledMatrix(l, [i, r], n), a.doAnimation(l, {matrix: o}, e)
            }
        }

        var a = n(114), o = n(26), s = n(7).Shape;
        t.exports = {
            groupWaveIn: function (t, e, n) {
                ...
                if (n.isPolar) {
                    ...
                    var u = n.start, l = n.end, h = Math.abs(u.x - l.x), f = Math.abs(u.y - l.y);
        ...
        t.exports = {
            directionEnabled: function (t, e) {
                ...
                if ("linear" === n) {
                    ...
                    var s = e, c = t.values, u = s.indexOf(c[0]), l = s.indexOf(c[c.length - 1]);
                    i = u / (s.length - 1), r = l / (s.length - 1)
                }
                return [i, r]
            }, _getLimitRange: function (t, e) {
                var n, a = e.field, o = e.type, s = r.Array.values(t, a);
        ...
        t.exports = {
            beforeGeomInit: function (t) {
                t.set("limitInPlot", !0);
                var e = t.get("data"), n = t.get("colDefs");
                if (!n) return e;
                var a = t.get("geoms"), o = !1;
                i.each(a, function (t) {
        ...
        var r = n(135), a = n(137), o = n(138), s = n(139), c = n(153);
        ...
        var r = n(0), a = n(9), o = function (t) {
            ...
            return n._initDefaultCfg = function () {
                ...
                var n = this.parsePoint(t, this.position), i = e.addShape("Circle", {
                    className: "guide-point",
                    attrs: r.mix({x: n.x + this.offsetX, y: n.y + this.offsetY}, this.style)
                });
                return this.element = i, i
            }, e
        }(a);
        ...
        var r = n(0), a = n(9), o = n(2).Rect, s = function (t) {
            function e() {
                return t.apply(this, arguments) || this
            }
            ...
            return n._initDefaultCfg = function () {
                ...
                var e = this.parsePoint(t, this.start), n = this.parsePoint(t, this.end);
                if (e && n) {
                    var i = new o({
                        attrs: {
                            x: Math.min(e.x, n.x),
                    ...
                    this.clip = i;
                    var a = this.chart, s = this.color, c = this.style || {}, u = [];
                    a.get("geoms").map(function (t) {
                        var e = t.get("container"), n = e.get("children"),
                            a = e.addGroup({zIndex: 10, className: "guide-region-filter"});
                        return n.map(function (t) {
                            if (t.get("isShape")) {
                                var e = t.get("type"), n = r.mix({}, t.get("attrs"), c);
        ...
        t.exports = {
            init: function (t) {
                ...
                var e = t.get("_horizontalBar"), n = t.get("_verticalBar");
                e && e.remove(!0), n && n.remove(!0), t.set("_horizontalBar", null), t.set("_verticalBar", null)
            }, afterGeomDraw: function (t) {
                var e = t.get("_scrollBarCfg");
                if (e) {
                    var n = t.get("data"), r = t.get("plotRange"), a = t.get("backPlot"),
                        o = t.get("canvas").get("height"), s = t.get("_limitRange"), c = e.mode;
                    if (i.directionEnabled(c, "x")) {
                        var u = e.xStyle, l = u.offsetX, h = u.offsetY, f = u.lineCap, p = u.backgroundColor,
                            g = u.fillerColor, d = u.size, v = t.getXScale(), y = s[v.field];
                        y || (y = i._getLimitRange(n, v), s[v.field] = y);
                        var m = i._getFieldRange(v, y, v.type), x = t.get("_horizontalBar"), _ = o - d / 2 + h;
                        x ? x.get("children")[1].attr({
                            x1: Math.max(r.bl.x + r.width * m[0] + l, r.bl.x),
                            x2: Math.min(r.bl.x + r.width * m[1] + l, r.br.x)
                        }) : ((x = a.addGroup({className: "horizontalBar"})).addShape("line", {
                            attrs: {
                                x1: r.bl.x + l,
                                y1: _,
                                x2: r.br.x + l,
                    ...
                    if (i.directionEnabled(c, "y")) {
                        var S = e.yStyle, b = S.offsetX, w = S.offsetY, P = S.lineCap, C = S.backgroundColor,
                            M = S.fillerColor, A = S.size, T = t.getYScales()[0], O = s[T.field];
                        O || (O = i._getLimitRange(n, T), s[T.field] = O);
                        var D = i._getFieldRange(T, O, T.type), k = t.get("_verticalBar"), I = A / 2 + b;
                        k ? k.get("children")[1].attr({
                            y1: Math.max(r.tl.y + r.height * D[0] + w, r.tl.y),
                            y2: Math.min(r.tl.y + r.height * D[1] + w, r.bl.y)
                        }) : ((k = a.addGroup({className: "verticalBar"})).addShape("line", {
                            attrs: {
                                x1: I,
                                y1: r.tl.y + w,
                                x2: I,
        ...
        !function (r, a, o, s) {
            ...
            function l(t, e, n) {
                var i;
                if (t) if (t.forEach) t.forEach(e, n); else if (t.length !== s) for (i = 0; i < t.length;) e.call(n, t[i], i, t), i++; else for (i in t) t.hasOwnProperty(i) && e.call(n, t[i], i, t)
            }
            ...
            function O(t, e, n) {
                var i = n.pointers.length, r = n.changedPointers.length, a = e & Ot && i - r == 0,
                    o = e & (kt | It) && i - r == 0;
            ...
            function D(t, e) {
                ...
                var a = n.firstInput, o = n.firstMultiple, s = o ? o.center : a.center, c = e.center = F(i);
            ...
            function k(t, e) {
                var n = e.center, i = t.offsetDelta || {}, r = t.prevDelta || {}, a = t.prevInput || {};
            ...
            function I(t, e) {
                var n, i, r, a, o = t.lastInterval || e, c = e.timeStamp - o.timeStamp;
                if (e.eventType != It && (c > Tt || o.velocity === s)) {
                    var u = e.deltaX - o.deltaX, l = e.deltaY - o.deltaY, h = Y(c, u, l);
            ...
            function V(t, e) {
                ...
                var r, a, o = b(t.changedTouches), s = [], c = this.target;
                if (a = n.filter(function (t) {
                    return m(t.target, c)
                }), e === Ot) for (r = 0; r < a.length;) i[a[r].identifier] = !0, r++;
            ...
            var gt, dt = ["", "webkit", "Moz", "MS", "ms", "o"], vt = a.createElement("div"), yt = "function",
                mt = Math.round, xt = Math.abs, _t = Date.now;
            ...
            var St = h(function (t, e, n) {
                    ...
                    return St(t, e, !0)
                }, "merge", "Use `assign`."), wt = 1, Pt = /mobile|tablet|ip(ad|hone|od)|android/i,
                Ct = "ontouchstart" in r, Mt = P(r, "PointerEvent") !== s, At = Ct && Pt.test(navigator.userAgent),
                Tt = 25, Ot = 1, Dt = 2, kt = 4, It = 8, Et = 1, Ft = 2, Yt = 4, Nt = 8, Bt = 16, Rt = Ft | Yt,
                jt = Nt | Bt, zt = Rt | jt, Xt = ["x", "y"], Lt = ["clientX", "clientY"];
            A.prototype = {
                handler: function () {
                }, init: function () {
            ...
            var Wt = {mousedown: Ot, mousemove: Dt, mouseup: kt}, Gt = "mousedown", Ht = "mousemove mouseup";
            f(X, A, {
                handler: function (t) {
                    var e = Wt[t.type];
            ...
            var Vt = {pointerdown: Ot, pointermove: Dt, pointerup: kt, pointercancel: It, pointerout: It},
                qt = {2: "touch", 3: "pen", 4: "mouse", 5: "kinect"}, Ut = "pointerdown",
            ...
            r.MSPointerEvent && !r.PointerEvent && (Ut = "MSPointerDown", Zt = "MSPointerMove MSPointerUp MSPointerCancel"), f(L, A, {
                handler: function (t) {
                    var e = this.store, n = !1, i = t.type.toLowerCase().replace("ms", ""), r = Vt[i],
                        a = qt[t.pointerType] || t.pointerType, o = "touch" == a, s = S(e, t.pointerId, "pointerId");
            ...
            var Jt = {touchstart: Ot, touchmove: Dt, touchend: kt, touchcancel: It}, $t = "touchstart",
            ...
            var ie = P(vt.style, "touchAction"), re = ie !== s, ae = "auto", oe = "manipulation", se = "none",
                ce = "pan-x", ue = "pan-y", le = function () {
                    if (!re) return !1;
            ...
            $.prototype = {
                set: function (t) {
                    ...
                    if (this.manager.session.prevented) e.preventDefault(); else {
                        var i = this.actions, r = x(i, se) && !le[se], a = x(i, ue) && !le[ue], o = x(i, ce) && !le[ce];
                        if (r) {
                            var s = 1 === t.pointers.length, c = t.distance < 2, u = t.deltaTime < 250;
                            if (s && c && u) return
                        }
            ...
            var he = 1, fe = 2, pe = 4, ge = 8, de = ge, ve = 16;
            Q.prototype = {
                ...
                defaults: {pointers: 1}, attrTest: function (t) {
                    ...
                    var e = this.state, n = t.eventType, i = e & (fe | pe), r = this.attrTest(t);
                ...
                directionTest: function (t) {
                    var e = this.options, n = !0, i = t.distance, r = t.direction, a = t.deltaX, o = t.deltaY;
                ...
                process: function (t) {
                    ...
                    if (this._input = t, !i || !n || t.eventType & (kt | It) && !r) this.reset(); else if (t.eventType & Ot) this.reset(), this._timer = c(function () {
                        this.state = de, this.tryEmit()
                    }, e.time, this); else if (t.eventType & kt) return de;
                    return 32
                },
                reset: function () {
                ...
                defaults: {event: "swipe", threshold: 10, velocity: .3, direction: Rt | jt, pointers: 1},
                getTouchAction: function () {
                ...
                inputTarget: null,
                inputClass: null,
                preset: [[st, {enable: !1}], [at, {enable: !1}, ["rotate"]], [ct, {direction: Rt}], [rt, {direction: Rt}, ["swipe"]], [ut], [ut, {
                    event: "doubletap",
                    taps: 2
                }, ["tap"]], [ot]],
                cssProps: {
            ...
            ht.prototype = {
                set: function (t) {
                    ...
                    if (t = this.get(t)) {
                        var e = this.recognizers, n = S(e, t);
        ...
        var a = n(0), o = n(45), s = n(15), c = function (t) {
            function e(e, n) {
            ...
            return n.getDefaultCfg = function () {
                ...
                var e = null, n = this.chart.get("geoms")[0], i = n.get("container").get("children");
                ...
                var e = this.offset, n = this.style, i = this.appendRadius, r = this.chart;
                this.lastShape = t;
                var o = t._attrs.attrs, s = o.x, c = o.y, u = o.startAngle, l = o.endAngle, h = o.r, f = o.fill,
                ...
                this.halo = p;
                var g = this.animate;
                g && (!0 === g && (g = {duration: 300}), p.attr("r", h + e), p.animate().to(a.mix({attrs: {r: h + e + i}}, g)))
            }, n.start = function (t) {
                var e = this.chart;
                "tap" === t.type && (t.clientX = t.center.x, t.clientY = t.center.y);
                var n = a.createEvent(t, e), i = n.x, r = n.y;
                this.halo && this.halo.remove(!0);
                var o = e.getSnapRecords({x: i, y: r});
                if (!o.length) return this.selected = !1, void (this.selectedShape = null);
                var s = o[0]._origin, c = this._getSelectedShapeByData(s), u = this.lastShape;
        ...
        var r = n(0), a = n(26), o = n(45), s = n(15), c = function (t) {
            function e(e, n) {
                var i, a = (i = t.call(this, e, n) || this).defaultSelected;
                if (r.isObject(a)) {
                    var o = i._selectShapesByData(a), s = o.selectedShape, c = o.unSelectedShapes;
            ...
            return n.getDefaultCfg = function () {
                ...
                return e = r.mix({}, e, {
                    ...
                    processEvent: null,
                    selectAxis: !0,
                    selectAxisStyle: {fontWeight: "bold"},
                    mode: "shape",
                    selectStyle: {fillOpacity: 1},
                    unSelectStyle: {fillOpacity: .4},
                    cancelable: !0,
                    defaultSelected: null
                ...
                var e = this.chart.get("geoms")[0], n = e.get("container").get("children"), i = null, a = [];
                ...
                var n = this.selectStyle, i = this.unSelectStyle, a = this.selectAxisStyle, o = this.chart;
                ...
                if (t.attr(n), r.each(e, function (t) {
                    ...
                    var c, u = o.get("geoms")[0].getXScale(), l = t.get("origin")._origin, h = o.get("axisController"),
                        f = h.frontPlot, p = h.backPlot;
                ...
                var e = this.chart;
                "tap" === t.type && (t.clientX = t.center.x, t.clientY = t.center.y);
                var n, i = r.createEvent(t, e), o = i.x, s = i.y, c = this.mode,
                    u = e.get("geoms")[0].get("container").get("children"), l = [];
                if ("shape" === c) {
                ...
                if (n) if (this.selectedShape = n, n.get("_selected")) {
                    if (!this.cancelable) return void this._setEventData(t);
                    this.reset()
                } else this._selectShapes(n, l); else this.reset();
        ...
        var a = n(0), o = n(145), s = n(45), c = n(15), u = n(146),
            l = ["touchstart", "touchmove", "touchend", "touchStart", "touchMove", "touchEnd"], h = function (t) {
                function e(e, n) {
                    var i, o = r(r(i = t.call(this, e, n) || this)), s = o.hammer, c = o.panThreshold, l = o.pressThreshold,
                        h = o.pressTime;
                    s && s.get("pan").set({threshold: c});
                ...
                return n.getDefaultCfg = function () {
                    ...
                    var e, n, i = this.currentDeltaX, r = this.currentDeltaY, o = this.lastPoint;
                    ...
                    if (!a.isNil(e) || !a.isNil(n)) {
                        var c = this._timestamp, u = +new Date;
                        u - c > 16 && (this._doPan(e, n), this._timestamp = u)
                    }
                }, n._doPan = function (t, e) {
                    var n = this, i = n.mode, r = n.chart, s = n.limitRange, c = r.get("coord"), u = c.start, l = c.end,
                        h = r.get("data");
                    if (o.directionEnabled(i, "x") && 0 !== t) {
                        var f = r.getXScale(), p = f.field;
                    ...
                    var r = t.field, s = t.min, c = t.max, u = this.limitRange;
                    if (s !== u[r].min || c !== u[r].max) {
                        var l = this.chart, h = e / n * (c - s), f = "x" === i ? c - h : c + h,
                            p = "x" === i ? s - h : s + h;
                        u[r] && !a.isNil(u[r].min) && p <= u[r].min && (f = c - s + (p = u[r].min)), u[r] && !a.isNil(u[r].max) && f >= u[r].max && (p = (f = u[r].max) - (c - s));
                        var g = o.getColDef(l, r);
                        l.scale(r, a.mix({}, g, {min: p, max: f, nice: !1}))
                    }
                }, n._panCatScale = function (t, e, n) {
                    var i = this.chart, r = t.type, s = t.field, c = t.values, u = t.ticks, l = o.getColDef(i, s),
                        h = this.limitRange[s], f = e / n, p = c.length, g = Math.max(1, Math.abs(parseInt(f * p))),
                        d = h.indexOf(c[0]), v = h.indexOf(c[p - 1]);
                    if (e > 0 && d >= 0) {
                        for (var y = 0; y < g && d > 0; y++) d -= 1, v -= 1;
                        var m = h.slice(d, v + 1), x = null;
                        if ("timeCat" === r) {
        ...
        var a = n(0), o = n(145), s = n(45), c = n(15), u = n(146), l = function (t) {
            function e(e, n) {
                var i, o = r(r(i = t.call(this, e, n) || this)), s = o.hammer, c = o.pressThreshold, l = o.pressTime;
                s.get("pinch").set({enable: !0}), n.registerPlugins([u, {
                    changeData: function () {
            ...
            return n.getDefaultCfg = function () {
                ...
                var e, n = 1 / this.currentPinchScaling * t.scale, i = t.target.getBoundingClientRect(),
                    r = {x: t.center.x - i.left, y: t.center.y - i.top},
                    a = Math.abs(t.pointers[0].clientX - t.pointers[1].clientX),
                    o = Math.abs(t.pointers[0].clientY - t.pointers[1].clientY), s = a / o;
                ...
                var i, r = this, s = r.mode, c = r.chart, u = r.limitRange;
                i = "xy" === s && void 0 !== n ? n : "xy";
                var l = c.get("data");
                if (o.directionEnabled(s, "x") && o.directionEnabled(i, "x")) {
                    var h = c.getXScale(), f = h.field;
                ...
                if ("linear" === t.type) {
                    var r = t.field, s = this.chart, c = t.min, u = t.max, l = u - c, h = this.limitRange,
                        f = h[r].max - h[r].min, p = s.get("coord"), g = o.getColDef(s, r), d = l * (e - 1);
                    ...
                    var m = p.invertPoint(n), x = "x" === i ? m.x : m.y, _ = u - d * (1 - x), S = c + d * x;
                    s.scale(r, a.mix({}, g, {min: S, max: _, nice: !1}))
                }
            }, n._zoomCatScale = function (t, e, n) {
                var i = t.field, r = t.values, s = this.chart, c = s.get("coord"), u = o.getColDef(s, i);
                this.originTicks || (this.originTicks = t.ticks);
                var l = this.originTicks, h = this.limitRange[i], f = h.length, p = f / (this.maxScale || 4),
                    g = f / (this.minScale || 1), d = r.length, v = c.invertPoint(n).x,
                    y = parseInt(d * Math.abs(e - 1)), m = parseInt(y * v), x = y - m;
                if (e >= 1 && d >= p) {
                    var _ = r.slice(m, d - x);
                    s.scale(i, a.mix({}, u, {values: _, ticks: l}))
                } else if (e < 1 && d <= g) {
                    var S = h.indexOf(r[0]), b = h.indexOf(r[d - 1]), w = Math.max(0, S - m), P = Math.min(b + x, f),
                        C = h.slice(w, P);
                    s.scale(i, a.mix({}, u, {values: C, ticks: l}))
                }
            }, e
        }(s);
